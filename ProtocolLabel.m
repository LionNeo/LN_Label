...
- (void)makeSubviews{
    AgreenButton *btn = [AgreenButton exButtonWithTitle:nil ImageName:@"non_agree" SelectImage:@"yes_agree"];
...
- (void)btnClick{
    ...
    !self.btnBlock? : self.btnBlock(self.agreebutton);
}
