...
+ (instancetype)labelWithFrame:(CGRect)frame text:(NSString *)textString textFont:(CGFloat)fontSize LinkColor:(UIColor *)linkColor LinkRang:(NSRange)linkRang ButtonClickBlock:(BtnClickBlock)btnClickBlock ProtocolLabelActionBlock:(ProtocolClickBlock)protocolActionBlock{
    ...
    return [[self alloc] labelWithFrame:frame text:textString textFont:fontSize  LinkColor:linkColor LinkRang:linkRang ButtonClickBlock:btnClickBlock ProtocolLabelActionBlock:protocolActionBlock];
}
...
- (instancetype)labelWithFrame:(CGRect)frame text:(NSString *)textString textFont:(CGFloat)fontSize  LinkColor:(UIColor *)linkColor LinkRang:(NSRange)linkRang ButtonClickBlock:(BtnClickBlock)btnClickBlock ProtocolLabelActionBlock:(ProtocolClickBlock)protocolActionBlock{
    ...
    return  [self initWithFrame:frame text:textString textFont:fontSize LinkColor:linkColor LinkRang:linkRang];
}

- (instancetype)initWithFrame:(CGRect)frame text:(NSString *)textString textFont:(CGFloat)fontSize LinkColor:(UIColor *)linkColor LinkRang:(NSRange)linkRang {
...
//    [btn sizeToFit];
    ...
    label.font = [UIFont systemFontOfSize:!_fontSize? 10.0:_fontSize];
...
- (void)btnClick:(UIButton *)sender{
    _agreebutton.selected = !_agreebutton.isSelected;
